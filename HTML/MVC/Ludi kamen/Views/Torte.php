...
<html>
    ...
    <body>
        ...
        <div id="filteri">
            ...
            <br /><br />
            <form name="forma-filteri" method='POST' action="http://localhost:8080/LudiKamen/Codeigniter/index.php/Pretraga/Torte">
        ...
        <div id="pretraga">
            ...
            foreach ($query as $row) { 
                ...
                $link = 'http://localhost:8080/LudiKamen/Codeigniter/index.php/Pregled/Torte/' . $ime;
            ?>
