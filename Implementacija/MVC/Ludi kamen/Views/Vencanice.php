...
<html>
    ...
    <head>
        <title> Pretraga salona venčanica </title>
        <style>
    ...
    <body>
        ...
        <div id="filteri">
            ...
            <br /><br />
            <form name="forma-filteri" method='POST' action="http://localhost:8080/LudiKamen/Codeigniter/index.php/Pretraga/Vencanice">
        ...
        <div id="pretraga">
            ...
            <font id="naslov2" style="font-size:30px"> Pregled salona venčanica </font>
            <br /><br />
            ...
            foreach ($query as $row) { 
                ...
                $link = 'http://localhost:8080/LudiKamen/Codeigniter/index.php/Pregled/Vencanice/' . $ime;
            ?>
