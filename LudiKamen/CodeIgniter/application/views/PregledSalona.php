...
<html>
    ...
    <body>
        ...
        <?php
            ...
            $link1 = "http://localhost:8080/Projekat/LudiKamen/Codeigniter/index.php/Pretraga/Vencanice";
        ?>
        ...
        <?php 
            if ($brRedova == 0) {
                echo "<font id='naslov2' style='margin: 5%'> Trenutno nema venčanica u ponudi. </font> <br><br>";
            }
            else {
            foreach ($query1 as $row) { 
                ...
                $link = 'http://localhost:8080/Projekat/LudiKamen/Codeigniter/index.php/Rezervacija/Vencanica/' . $i . '/' . $ime;
        ?>
